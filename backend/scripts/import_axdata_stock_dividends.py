#!/usr/bin/env python3
"""Import a validated AxData XDXR snapshot into TickFlow corporate actions."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Import AxData stock XDXR cash dividends")
    parser.add_argument("source", type=Path, help="AxData stock_capital_changes_tdx parquet snapshot")
