...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("limit_up_expression", "apphis.longhuvip.com", "POST"),
        ("rise_fall_analysis", "apphwshhq.longhuvip.com", "GET"),
        ("market_performance", "apphwshhq.longhuvip.com", "GET"),
        ("market_sentiment_history", "apphis.longhuvip.com", "GET"),
        ("market_sentiment_realtime", "apphwhq.longhuvip.com", "GET"),
        ("limit_up_ladder", "apphwhq.longhuvip.com", "POST"),
        (76, "apphwhq.longhuvip.com", "POST"),
