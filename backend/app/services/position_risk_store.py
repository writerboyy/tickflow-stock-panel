...
def default_template() -> dict[str, Any]:
    return {
        "rules": {
            ...
            "stop_loss": {"enabled": False, "notify": False, "threshold": -0.10, "action_pct": 100},
            "take_profit": {"enabled": False, "notify": False, "threshold": 0.10, "action_pct": 100},
            "trailing_drawdown": {"enabled": False, "notify": False, "activation_gain": 0.05, "threshold": 0.08, "action_pct": 50},
            "take_profit_ladder": {
            ...
            "five_minute_drawdown": {"enabled": False, "notify": False, "threshold": 0.03, "action_pct": 25},
            "vwap_breakdown": {"enabled": False, "notify": False, "buffer": 0.01, "sustain_seconds": 30, "action_pct": 25},
            "broken_limit_up": {"enabled": False, "notify": False, "action_pct": 50},
            ...
            "limit_down": {"enabled": False, "notify": False, "action_pct": 100},
            "large_buy": {
