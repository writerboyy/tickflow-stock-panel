...
def default_template() -> dict[str, Any]:
    return {
        "rules": {
            ...
            "five_minute_drawdown": {"enabled": True, "notify": False, "threshold": 0.03, "action_pct": 25},
            "vwap_breakdown": {"enabled": True, "notify": False, "buffer": 0.01, "sustain_seconds": 30, "action_pct": 25},
            "broken_limit_up": {"enabled": True, "notify": False, "action_pct": 50},
            "resealed_limit_up": {"enabled": True, "notify": False, "action_pct": 0},
            "sealed_order_shrink_50": {"enabled": True, "notify": False, "threshold": 0.50, "action_pct": 25},
            "sealed_order_shrink_80": {"enabled": True, "notify": False, "threshold": 0.80, "action_pct": 50},
            "limit_down": {"enabled": True, "notify": False, "action_pct": 100},
            "large_buy": {
